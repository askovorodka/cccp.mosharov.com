...
$css[] = BASE_URL."/templates/style_25-05-11.css";
...
$js[]=BASE_URL."/javascript/tools_02-2-02-12.js";
...
//if ($current_url == 'home')
{
	...
	$tires_manufacturer = $db->get_all("
		...
		where a.param_level = '2' and a.status = '1' and b.id = " . TIRES_ID . ' ORDER BY a.name');
	//шины ширина
	...
	$disk_manufacturer = $db->get_all("
		...
		left join 
		fw_catalogue as b on a.param_left > b.param_left and a.param_right < b.param_right 
		where a.param_level = '2' and a.status = '1' and b.id = " . DISK_ID . ' ORDER BY a.name');
